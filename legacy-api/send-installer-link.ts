...
function getReleaseLink(os: string) {
  if (os === 'windows') {
    return 'https://github.com/X-RayLuan/ClawLite-Installer/releases/download/v1.3.89/clawlite-setup.exe';
  }
  return 'https://github.com/X-RayLuan/ClawLite-Installer/releases/download/v1.3.89/clawlite.dmg';
}
