...
export const content = {
  ...
  downloads: {
    en: {
      ...
      publicPageTitle: "Download ClawLite Installer",
      publicPageDesc: "Download the installer for your OS. Create an account to manage your license and activation.",
      login: "Login",
      register: "Register",
      apiKey: {
    ...
    zh: {
      ...
      publicPageTitle: "下载 ClawLite 安装程序",
      publicPageDesc: "下载适合你操作系统的安装程序。创建账号以管理许可证和激活。",
      login: "登录",
      register: "注册",
      apiKey: {
    ...
    es: {
      ...
      publicPageTitle: "Descarga el Instalador de ClawLite",
      publicPageDesc: "Descarga el instalador para tu sistema operativo. Crea una cuenta para gestionar tu licencia y activación.",
    ...
    ja: {
      ...
      publicPageTitle: "ClawLite インストーラーをダウンロード",
      publicPageDesc: "オペレーティングシステム用のインストーラーをダウンロード。アカウントを作成してライセンスとアクティベートを管理できます。",
      login: "ログイン",
      register: "登録",
      apiKey: {
    ...
    ko: {
      ...
      publicPageTitle: "ClawLite 인스톨러 다운로드",
      publicPageDesc: "운영 체제용 인스톨러를 다운로드하세요. 계정을 만들어 라이선스와 활성화를 관리할 수 있습니다.",
      login: "로그인",
      register: "회원가입",
      apiKey: {
  ...
  dashboard: {
    en: {
      ...
      apiKeysPage: {
        ...
        buttons: { createNew: "Create New Key", show: "Show", copy: "Copy", copied: "Copied", reveal: "Reveal", revealing: "Revealing...", regenerate: "Regenerate", regenerating: "Regenerating...", delete: "Delete", deleting: "Deleting...", done: "Done" },
    ...
    zh: {
      ...
      apiKeysPage: {
        ...
        buttons: { createNew: "创建新密钥", show: "显示", copy: "复制", copied: "已复制", reveal: "显示密钥", revealing: "显示中...", regenerate: "重新生成", regenerating: "重新生成中...", delete: "删除", deleting: "删除中...", done: "完成" },
    ...
    es: {
      ...
      apiKeysPage: {
        ...
        buttons: { createNew: "Crear Nueva Clave", show: "Mostrar", copy: "Copiar", copied: "Copiado", reveal: "Revelar", revealing: "Revelando...", regenerate: "Regenerar", regenerating: "Regenerando...", delete: "Eliminar", deleting: "Eliminando...", done: "Hecho" },
    ...
    ja: {
      ...
      apiKeysPage: {
        ...
        buttons: { createNew: "新規キーを作成", show: "表示", copy: "コピー", copied: "コピー済み", reveal: "表示", revealing: "表示中...", regenerate: "再生成", regenerating: "再生成中...", delete: "削除", deleting: "削除中...", done: "完了" },
    ...
    ko: {
      ...
      apiKeysPage: {
        ...
        buttons: { createNew: "새 키 생성", show: "보기", copy: "복사", copied: "복사됨", reveal: "표시", revealing: "표시 중...", regenerate: "재생성", regenerating: "재생성 중...", delete: "삭제", deleting: "삭제 중...", done: "완료" },
