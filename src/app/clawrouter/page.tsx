...
const featureRows = [
  ...
  },
  {
    ...
    body:
      "This is the practical core: ClawRouter should feel like the obvious managed alternative to manual BYOK setup when a user wants a faster route from setup to working AI.",
...
const modelCards = [
  ...
  },
  {
    ...
    body: "The most important promise is simple: faster path from setup to useful AI calls, with less setup drag than raw BYOK.",
  },
];
